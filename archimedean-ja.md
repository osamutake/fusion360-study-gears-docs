...
単なる平歯車を用いるよりも実用的なつるまきたが歯車＆専用ピニオンのペアを成形し、
組み合わせて動かすことを試みます。
...
結局のところ、今の場合 $m_n=4$ に対して $m_t=4.0022$ ですので、
頑張って両者を区別する価値はあまりなさそうです。
...
通常のラック＆ピニオンの噛み合いと同様の安定した接触が得られていることを確認できます。
